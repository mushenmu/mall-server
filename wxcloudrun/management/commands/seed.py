...
PRODUCTS = [
    # (标题, 图片, 售价分, 库存, 销量, (父分类, 子分类) 或 顶级分类名, 标签)
    ("白色短袖连衣裙荷叶边裙摆宽松韩版休闲纯白清爽优雅连衣裙", "goods/nz-09a.png", 29800, 510, 1020, ("女装", "连衣裙"), ["限时抢购"]),
    ("纯色纯棉休闲圆领短袖T恤纯白亲肤厚柔软细腻面料短袖套头T恤", "goods/nz-08b.png", 25900, 320, 880, ("女装", "卫衣"), ["2024夏季新款"]),
    ("带帽午休毯多功能加厚加大加绒简约连帽披肩", "goods/muy-3a.png", 29900, 200, 430, "女装", ["火爆"]),
    ("运动连帽拉链卫衣休闲开衫长袖多色细绒面料运动上衣", "goods/nz-17a.png", 25900, 60, 540, ("男装", "卫衣"), ["运动"]),
    ("纯棉针织半身裙复古高腰a字中长裙显瘦百搭半身裙", "goods/nz-09a.png", 19900, 150, 230, ("女装", "半身裙"), []),
    ("自然堂雪域精粹纯粹滋润霜补水保湿面霜化妆品套装", "goods/mz-20a1.png", 19900, 80, 670, ("美妆", "唇釉"), ["美妆"]),
    ("不锈钢刀叉勺套装家用西餐餐具简约耐用金色银色可选", "goods/gh-2b.png", 29900, 90, 320, "女装", []),
    ("腾讯极光盒子智能网络电视机顶盒4K高分辨率网络机顶盒", "goods/dz-3a.png", 9900, 120, 1560, ("数码", "手机配件"), ["新品"]),
    ("男士休闲直筒裤宽松百搭长裤秋季新款", "goods/nz-17a.png", 21900, 180, 410, ("男装", "裤子"), []),
    ("轻薄羽绒服短款立领保暖外套男女同款", "goods/nz-08b.png", 39900, 75, 260, "男装", ["冬季"]),
]
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for title, img, price, stock, sales, cat_key, tags in PRODUCTS:
